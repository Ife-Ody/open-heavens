...
export const SHORT_DOMAIN =
  process.env.NEXT_PUBLIC_APP_SHORT_DOMAIN || "openheavens.app";
...
export const APP_DOMAIN =
  process.env.NEXT_PUBLIC_VERCEL_ENV === "production"
    ...
    : process.env.NEXT_PUBLIC_VERCEL_ENV === "preview"
      ? "https://app.preview.openheavens.app"
      : "http://localhost:7300";
...
export const SYSX_LOGO =
  "https://files.openheavens.app/thumb-logo-base-32x32.png";
