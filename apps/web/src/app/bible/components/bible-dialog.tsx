...
export function BibleDialog({
  ...
  if (isMobile) {
    return (
      <Drawer open={open} onOpenChange={onOpenChange}>
        {children}
        <DrawerContent className="px-2 pb-6 h-[95svh] data-[vaul-drawer-direction=bottom]:max-h-[95svh] data-[vaul-drawer-direction=top]:max-h-[95svh]">
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      {children}
      <DialogContent className="h-[90svh] w-[95svw] sm:max-w-4xl max-w-3xl p-0 sm:px-2 py-2 bg-background [&>button]:hidden flex flex-col">
